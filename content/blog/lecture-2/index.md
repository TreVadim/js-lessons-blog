...
date: "2020-05-07"
description: "Обзор синтаксисас базовых конструкций. Переменные. Типы"
---
...
Возможные значение - true и false
...
Сравнения с помощью операторов >, <, >=, <= ===  регистрозависимые 
...
Модальное окно для полуечения данных - prompt
```javascript
